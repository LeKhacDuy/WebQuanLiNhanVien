<?php
  ...
  if (!isset($_SESSION['taikhoan']) && !isset($_SESSION['manv'])) {
	...
	include('../header.php');
    $allNghiPhep = json_decode(layNghiPhep_truongphong()) -> data;
        ...
        <div class="container-fluid mt-5 ">
            ...
            <div class="col-md-12 mb-3">
                ...
                <div class="card-header">
                    <span><i class="bi bi-table me-2"></i></span> Danh sách các đơn xin nghỉ phép của các trưởng phòng
                </div>
                <div class="card-body">
                            ...
                            <?php foreach($allNghiPhep as $nghiphep) { ?>
                                <?php if($nghiphep-> manv != $nhanvien['manv']) { ?> 
                                    <tr class="align-middle"> 
                                        ...
                                        <td><?=tenPB(lay1NV_manv($nghiphep->manv)['mapb'])?></td>
